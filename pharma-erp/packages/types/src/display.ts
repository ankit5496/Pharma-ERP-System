...
const ACRONYMS = new Set([
  ...
  'IP', 'BP', 'USP', 'EP', 'JP', 'NF', 'API', 'GMP', 'GLP', 'WHO', 'ISO',
  // Regulatory and commercial
  'GST', 'GSTIN', 'HSN', 'MRP', 'DPCO', 'NLEM', 'PAN', 'TAN', 'CIN', 'FSSAI',
  // Documents this system issues
  'PR', 'PO', 'GRN', 'QC', 'MI', 'JW', 'JWR', 'JWI', 'SO', 'DSP', 'RCPT',
  'SRTN', 'PINV', 'SINV', 'BMR', 'BPR', 'COA', 'LOT', 'FEFO', 'UOM', 'ID',
